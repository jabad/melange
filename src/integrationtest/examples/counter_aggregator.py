...
class SampleDomainEvent(Event):
    def __init__(self, data1):
        super(SampleDomainEvent, self).__init__()
...
#         Subscriber.__init__(self, topic)
...
#
#     def listens_to(self):
#         return SampleDomainEvent.event_type_name
#
...
if __name__ == '__main__':
    ...
    topic_counters = ['c1', 'c2', 'c3', 'c4']

    a = inspect.getmembers(sys.modules['melange'])
    b = 2
    #subcr = counter_aggregator(topic_counters)
    #producer = count_producer(topic_counters, ebus)
